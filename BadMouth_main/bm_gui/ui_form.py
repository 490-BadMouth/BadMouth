...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_processing_toggle = QLabel(self.page_home)
        self.label_processing_toggle.setObjectName(u"label_processing_toggle")
        self.label_processing_toggle.setGeometry(QRect(100, 0, 801, 61))
        self.label_processing_toggle.setFont(font2)
        self.label_processing_toggle.setAlignment(Qt.AlignCenter)
        ...
        self.dial_bass.setMinimum(-11)
        self.dial_bass.setMaximum(11)
        ...
        self.dial_mid.setMinimum(-11)
        self.dial_mid.setMaximum(11)
        ...
        self.dial_treb.setMinimum(-11)
        self.dial_treb.setMaximum(11)
        ...
        self.gridLayoutWidget_2.setGeometry(QRect(40, 260, 921, 301))
        ...
        self.lcdNumber.setProperty("intValue", 9469)
        ...
        self.lcdNumber_3.setProperty("intValue", 1620)
        ...
        self.lcdNumber_5 = QLCDNumber(self.gridLayoutWidget_2)
        self.lcdNumber_5.setObjectName(u"lcdNumber_5")
        self.lcdNumber_5.setFrameShape(QFrame.Panel)
        self.lcdNumber_5.setFrameShadow(QFrame.Sunken)
        self.lcdNumber_5.setProperty("intValue", 573)

        self.gridLayout.addWidget(self.lcdNumber_5, 0, 3, 1, 1)
        ...
        self.lcdNumber_6 = QLCDNumber(self.gridLayoutWidget_2)
        self.lcdNumber_6.setObjectName(u"lcdNumber_6")
        self.lcdNumber_6.setFrameShape(QFrame.Panel)
        self.lcdNumber_6.setFrameShadow(QFrame.Sunken)
        self.lcdNumber_6.setProperty("intValue", 120)

        self.gridLayout.addWidget(self.lcdNumber_6, 1, 3, 1, 1)
        ...
        self.pushButton = QPushButton(self.page_stats)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(840, 20, 141, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_processing_toggle.setText(QCoreApplication.translate("MainWindow", u"Audio Processing: Enabled", None))
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Bad Words Blocked", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Sh*ts Disposed of:", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"D*cks Blocked:", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"F-Bombs dropped:", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"A**es Covered:", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Other Nasty Words Spoken:", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"RESET STATS", None))
    # retranslateUi
